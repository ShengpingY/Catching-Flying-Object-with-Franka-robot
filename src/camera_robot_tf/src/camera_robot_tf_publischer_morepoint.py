...
def main():
    global Array_Point_A, Array_Point_B,point_A,point_B
    ...
    pub = rospy.Publisher('/transformed_coord_mp', Point, queue_size=1)
    rospy.sleep(1)
    ...
    # while True:
        ...
        if len(Array_Point_A) >= 5 and len(Array_Point_B) >= 100:
            break
